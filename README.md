...
เจ้าของล็อกอินด้วยอีเมลและรหัสผ่าน Supabase Auth ใน /adminpage-settings แล้วเข้าหน้าอนุมัติทั้งสามได้โดยไม่ต้องใช้รหัสชุดผู้อนุมัติ จากนั้นตั้งรหัสผ่านแยกสามชุด (ไม่กำหนดความยาว แต่ห้ามเว้นว่าง) ในหน้าตั้งค่า หน้าอนุมัติใช้แค่รหัสผ่าน ไม่ต้องกรอกอีเมล รหัสยังไม่ถูกตั้งจะเข้าไม่ได้
